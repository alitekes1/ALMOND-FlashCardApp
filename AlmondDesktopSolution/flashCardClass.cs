...
namespace formsApp
{
    public class flashCardClass
    {
        ...
        {
            // SQL için gerekli olan bağlantı adresi.Her cihaza göre değişklik göstermektedir.
            string connectionSql = "Data Source=LAPTOP-CG4B31DN\\SQLEXPRESS;Initial Catalog=AlmondDesktopDB;Integrated Security=True";
